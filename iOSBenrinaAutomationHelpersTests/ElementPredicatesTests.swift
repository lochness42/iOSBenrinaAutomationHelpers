...
class ElementPredicatesTests: XCTestCase {
    ...
    func testContainsPredicateFormat() {
        let containsPredicate = ElementPredicate.contains(.text, "test")
    ...
    func testDoesNotContainPredicateFormat() {
        let doesNotContainPredicate = ElementPredicate.doesNotContain(.text, "test")
    ...
    func testEqualsPredicateFormat() {
        let equalsPredicate = ElementPredicate.equals(.text, "test")
    ...
    func testDoesNotEqualPredicateFormat() {
        let doesNotEqualPredicate = ElementPredicate.doesNotEqual(.text, "test")
    ...
    func testBeginsWithPredicateFormat() {
        let beginsWithPredicate = ElementPredicate.beginsWith(.text, "test")
    ...
    func testDoesNotBeginWithPredicateFormat() {
        let doesNotBeginWithPredicate = ElementPredicate.doesNotBeginWith(.text, "test")
    ...
    func testEndsWithPredicateFormat() {
        let endsWithPredicate = ElementPredicate.endsWith(.text, "test")
    ...
    func testDoesNotEndWithPredicateFormat() {
        let doesNotEndWithPredicate = ElementPredicate.doesNotEndWith(.text, "test")
    ...
    func testMatchesWithRegexPredicateFormat() {
        let matchesWithRegexPredicate = ElementPredicate.matchesWithRegex(.text, "test")
    ...
    func testDoesNotMatchWithRegexPredicateFormat() {
        let doesNotMatchWithRegexPredicate = ElementPredicate.doesNotMatchWithRegex(.text, "test")
    ...
    func testIsOneOfTheValuesPredicateFormat() {
        let isOneOfTheValuesPredicate = ElementPredicate.isOneOfTheValues(.text, ["test", "test2"])
    ...
    func testIsNotOneOfTheValuesPredicateFormat() {
        let isNotOneOfTheValuesPredicate = ElementPredicate.isNotOneOfTheValues(.text, ["test", "test2"])
